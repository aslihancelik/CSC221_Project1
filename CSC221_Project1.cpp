...
int main()
{
	...
	do {
		...
		if (remainingPay < 0) {
			cout << "Salesperson need to pay back $" << remainingPay * (-1) << "." << endl << endl;
		}

		cout << "Please type 'exit' if you would like to exit the program or type 'continue' if you would like to continue:" << endl;
		cin >> readInput;
		if (readInput == "exit") {
